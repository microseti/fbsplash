...
// rotate, enlarge и fit_to_screen можно сделать при запуске (в параметрах программы)
...
void help(char *name)
{
	printf("Usage: %s [options] image1 image2 image3 ...\n\n"
           ...
           " --delay <d>   | -s <delay> : Slideshow, 'delay' is the slideshow delay in hundths of seconds.\n\n"
		   "Keys:\n"
		   " r            : Redraw the image\n"
